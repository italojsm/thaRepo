 ...
 $.noConflict();
    ...
    $("#bt").click(function(){
        ...
        $("body").fadeOut(300, function(){
            ...
            $(window.document.location).attr('href','CadastrarEndereco.php');
            ...
            $.ajax({
                 ...
                 success: function(){
                            ...
                            $("body").fadeOut(500, function(){
                              ...
                              $(window).redirect('EditarCliente.php', { pagina: 'editar', id:txt });
...
<table class="table table-bordered table-striped">
 ...
 <?php while($row = $stmt->fetch(PDO::FETCH_ASSOC)){ if($row['fl_inativo'] != 1){ ?>
  ...
  <tr>
    ...
    <td> <a class="edit" onclick="return false"  href="Cliente.php" rel="<?php echo $row['id_cliente']; ?>">Editar</a> </td>
