    ...
    <div class="container">
      <div class="row">
        ...
        <div class="span12">
          ...
          <div class="widget">
          <span class="btn" id="bt"> Inserir novo Funcionario </span>
</div>
...
<table class="table table-bordered table-striped">
 ...
 <?php while($row = $stmt->fetch(PDO::FETCH_ASSOC)){ if($row['fl_inativo'] != 1){?>
  ...
  <tr>
    ...
    <td> <a class="edit" onclick="return false"  href="Contrato.php" rel="<?php echo $row['id_funcionario']; ?>">Editar</a> </td>
    <td> <a class="excluir" onclick="return false"  href="Contrato.php" rel="<?php echo $row['id_funcionario']; ?>"> Excluir </a></td>
  </tr>
