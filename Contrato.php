...
<script>
 ...
 $.noConflict();
 	...
 	//Ação para levar até a paginda de cadastro do contrato
    $("#bt").click(function(){
        
        $("body").fadeOut(500, function(){
                           
            $(window.document.location).attr('href','CadastrarContrato.php');
            ...
            $.ajax({
                 ...
                 success: function(){
                            ...
                            $("body").fadeOut(300, function(){
                              ...
                              $(window).redirect('EditarContrato.php', { pagina: 'editar', id:txt });
    ...
    $('a.excluir').click(function(){
           ...
           // alert(txt);
            ...
            var r= confirm("Você realmente deseja excluir este contrato?");
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="span12">
          ...
          <div class="widget">
          <span class="btn" id="bt"> Inserir novo Contrato </span>
</div>
...
<table class="table table-bordered table-striped">
 ...
 <?php while($row = $stmt->fetch(PDO::FETCH_ASSOC)){ if($row['fl_inativo'] != 1){?>
  ...
  <tr>
    <td> <?php echo $row['desc_contrato'] ?></td>
    <td> <a class="edit" onclick="return false"  href="Contrato.php" rel="<?php echo $row['id_contrato']; ?>">Editar</a> </td>
    <td> <a class="excluir" onclick="return false"  href="Contrato.php" rel="<?php echo $row['id_contrato']; ?>"> Excluir </a></td>
  </tr>
