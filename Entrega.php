            ...
            $.ajax({
                 ...
                 success: function(){
                          ...
                          //  alert("alohaaaa");
                              ...
                              $(window).redirect('Edicao/EditarEntrega.php', { pagina: 'editar', id:txt });
...
<table class="table table-bordered table-striped">
 ...
 <?php while($row = $stmt->fetch(PDO::FETCH_ASSOC)){ if($row['fl_inativo'] != 1){ ?>
  ...
  <tr>
    <td> <?php echo $row['desc_entrega'] ?></td>    
    <td> <a class="edit" onclick="return false"  href="Entrega.php" rel="<?php echo $row['id_entrega']; ?>">Editar</a> </td>
    <td> <a class="excluir" onclick="return false"  href="Entrega.php" rel="<?php echo $row['id_entrega']; ?>"> Excluir </a> </td>
  </tr>
