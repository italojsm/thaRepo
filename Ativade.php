...
<?php
   ...
   $stmt = $con->prepare("SELECT * FROM atividade");
   $stmt->execute();
...
<script>
 ...
 $.noConflict();
    ...
    $('a.edit').click(function(){
            ...
            $.ajax({
                 url: "Edicao/EditarAtividade.php",
                 ...
                 success: function(){
                            ...
                            alert("alohaaaa");
                              ...
                              $(window).redirect('Edicao/EditarAtividade.php', { pagina: 'editar', id:txt });
    ...
    $('a.excluir').click(function(){
           ...
           // alert(txt);
            ...
            if( r == true){  
	            $.ajax({
	                 url: "controle/EditarAtividade.php",
	                 //data: {pagina: 'editar', id: txt},
	                 data: { pagina: 'editar', id:txt},
	                 //context: document.body,
	                 type: "POST",
	                 success: function(){
	                 		alert('ALOHAAA');
	                            $("body").fadeOut(500, function(){
	                             ...
	                             $(window.document.location).attr('href','Atividade.php');
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="span12">
          ...
          <div class="widget">
            <span class="btn" id="bt"> Inserir Atividade </span>
          </div>
...
<table class="table table-bordered table-striped">
 ...
 <?php while($row = $stmt->fetch(PDO::FETCH_ASSOC)){ if($row['fl_inativo'] != 1){ ?>
  ...
  <tr>
    <td> <?php echo $row['desc_atividade'] ?></td>    
    <td> <a class="edit" onclick="return false"  href="Atividade.php" rel="<?php echo $row['id_atividade']; ?>">Editar</a> </td>
    <td> <a class="excluir" onclick="return false"  href="Atividade.php" rel="<?php echo $row['id_atividade']; ?>"> Excluir </a> </td>
  </tr>
