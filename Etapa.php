            ...
            $.ajax({
                 ...
                 success: function(){
                            ...
                            alert("alohaaaa");
                              ...
                              $(window).redirect('Edicao/EditarEtapa.php', { pagina: 'editar', id:txt });
	                 ...
	                 success: function(){
	                 		alert('ALOHAAA');
	                            $("body").fadeOut(500, function(){
	                             ...
	                             $(window.document.location).attr('href','Etapa.php');
...
<table class="table table-bordered table-striped">
 ...
 <?php while($row = $stmt->fetch(PDO::FETCH_ASSOC)){ if($row['fl_inativo'] != 1){ ?>
  ...
  <tr>
    ...
    <td> <a class="edit" onclick="return false"  href="Etapa.php" rel="<?php echo $row['id_etapa']; ?>">Editar</a> </td>
    <td> <a class="excluir" onclick="return false"  href="Etapa.php" rel="<?php echo $row['id_etapa']; ?>"> Excluir </a> </td>
  </tr>
