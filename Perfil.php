...
<?php
   ...
   $stmt = $con->prepare("SELECT * FROM perfil");
   $stmt->execute();
 ...
 $.noConflict();
            ...
            $.ajax({
                 ...
                 success: function(){
                            ...
                            //alert("alohaaaa");
                              ...
                              $(window).redirect('Edicao/EditarPerfil.php', { pagina: 'editar', id:txt });
    ...
    $('a.excluir').click(function(){
           ...
           // alert(txt);
            ...
            if( r == true){  
	            $.ajax({
	                 url: "controle/EditaPerfilFuncionario.php",
	                 //data: {pagina: 'editar', id: txt},
	                 data: { pagina: 'editar', id:txt},
	                 //context: document.body,
	                 type: "POST",
...
<table class="table table-bordered table-striped">
 ...
 <?php while($row = $stmt->fetch(PDO::FETCH_ASSOC)){ if($row['fl_inativo'] != 1){ ?>
  ...
  <tr>
    <td> <?php echo $row['desc_perfil'] ?></td>    
    <td> <a class="edit" onclick="return false"  href="Perfil.php" rel="<?php echo $row['id_perfil']; ?>">Editar</a> </td>
    <td> <a class="excluir" onclick="return false"  href="Perfil.php" rel="<?php echo $row['id_perfil']; ?>"> Excluir </a> </td>
  </tr>
