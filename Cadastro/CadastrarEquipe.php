        ...
        /*
            $.ajax({
                 ...
                 success: function(){
                            ...
                            //alert('ALOHAAAA');
                            $(window.document.location).attr('href','CadastrarEquipe.php');                            
                            });
                 }
            });
          */
...
<div class="main">
  <div class="main-inner">
    <div class="container">
      <div class="row">
      	<div class="span12">
        <form class="form-horizontal widget-content"  method="post" action="../controle/InsereEquipe.php">
      <legend>Cadastro de Equipe</legend>
   
<fieldset>
          <div class="row-fluid">
            <div class="span6 bgcolor">
              <div class="control-group">
                <label class="control-label" for="street">Nome Equipe</label>
                <div class="controls">
                  <input type="text" id="nome_equipe" name="nome_equipe">
                </div>
              </div>             
            </div><!--/span-->
             ...
             <div class="span6 bgcolor">
              <div class="control-group">
                <label class="control-label" for="id_projeto">Projeto</label>
                <div class="controls">
            ...
            <div class="span6 bgcolor">
              <div class="control-group">
                <label class="control-label" for="street">Integrantes Equipe</label>
                <div class="controls">
                 <select id="id_funcionario" name="id_funcionario[]" size="3" multiple>
                  <?php
