    ...
    $("form").submit(function(){
       ...
       // $('#nomeFantasia').attr('name');
        ...
        //alert(dados);
            ...
            $.ajax({
                 url: "../controle/InsereTipoInteligencia.php",
                 data: dados, 
                 type: "POST",
                 success: function(){
                            ...
                            //alert('ALOHAAAA');
                            $(window.document.location).attr('href','../Cadastro/CadastroTipoInteligencia.php');                            
                            });
                 }
            });
          ...
          <div class="row-fluid">
            <div class="span6 bgcolor">
              <div class="control-group">
                ...
                <div class="controls">
                  <input type="text" id="desc_tipo_inteligencia" name="desc_tipo_inteligencia">
                </div>
              </div>             
            </div><!--/span-->
            </div><!--row-->
