    ...
    $("form").submit(function(){
       ...
       // $('#nomeFantasia').attr('name');
        ...
        //alert(dados);
            ...
            $.ajax({
                 url: "../controle/InsereAtividade.php",
                 data: dados, 
                 type: "POST",
                 success: function(){
...
<div class="main">
  <div class="main-inner">
    <div class="container">
      ...
      <legend>Cadastro de Ativade</legend>
...
<fieldset>
                 ...
                 <select id="id_etapa" name="id_etapa">
                  <?php
                       ...
                       while($tes = $stmt->fetch(PDO::FETCH_ASSOC)){?>
                  	        <option value="<?php echo $tes['id_etapa']; ?>"><?php echo $tes['etapa']; ?></option>
          ...
          <div class="row-fluid">
            ...
            <div class="span6 bgcolor">
              <div class="control-group">
                <label class="control-label" for="city">Desc Atividade</label>
                <div class="controls">
                  <textarea id="desc_atividade" name="desc_atividade"></textarea> 
                </div>
              </div>
            </div><!--/span-->
