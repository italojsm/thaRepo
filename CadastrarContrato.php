...
var output = ((''+day).length<2 ? '0' : '') + day  + '-' +
    ...
    $("form").submit(function(){
        ...
        var dados = $( this ).serialize();
            ...
            $.ajax({
                 url: "controle/InsereContrato.php",
                 data: dados, 
                 type: "POST",
                 success: function(){
...
<div class="main">
  <div class="main-inner">
    <div class="container">
      <div class="row">
      	<div class="span12">
        <form class="form-horizontal widget-content" method="POST" action="controle/InsereContrato.php">
...
<fieldset>
          ...
          <div class="row-fluid">
              ...
              <div class="control-group">
                ...
                <div class="controls">
                  <input type="text" id="desc_contato" name="desc_contrato"> 
                </div>
              </div>
            </div><!--/span-->
            ...
            <div class="span6 bgcolor">
              <div class="control-group">
                ...
                <div class="controls">
                  <input class="date" type="text" id="dt_inicio_vigencia" name="dt_inicio_vigencia"> 
                </div>
              </div>
            </div><!--/span-->
     ...
     <div class="span6 bgcolor">
              <div class="control-group">
                ...
                <div class="controls">
                  <input class="date" type="text" id="dt_fim_vigencia" name="dt_fim_vigencia"> 
                </div>
              </div>
            </div><!--/span-->
          </div><!--/row-->  
