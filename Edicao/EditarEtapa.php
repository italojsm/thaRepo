...
<?php
  ...
  //if(isset($_POST['pagina']))
   ...
   $stmt = $con->prepare("SELECT * FROM etapa where id_etapa = :id;");
          ...
          <div class="row-fluid">
            <div class="span6 bgcolor">
              <div class="control-group">
                ...
                <div class="controls">
                  <input type="text" id="etapa" name="etapa" value="<?php echo $tes['etapa']; ?>">
                </div>
              </div>             
            </div><!--/span-->
            </div><!--row-->
            ...
            <div class="span6 bgcolor">
              <div class="control-group">
                ...
                <div class="controls">
                  <textarea id="desc_etapa" name="desc_etapa"> <?php echo $tes['desc_etapa']; ?> </textarea> 
                </div>
              </div>
            </div><!--/span-->
          </div><!--row-->
           
           <input type="hidden" name="idEtapa" value="<?php echo $_POST['id']?>"> 
