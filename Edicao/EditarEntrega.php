...
<?php
  ...
  //if(isset($_POST['pagina']))
   ...
   $stmt = $con->prepare("SELECT * FROM entrega where id_entrega = :id;");
        ...
        //alert(dados);
            ...
            $.ajax({
                 ...
                 success: function(){
                            ...
                            //alert('ALOHAAAA');
                            $(window.document.location).attr('href','../Entrega.php');                            
                            });
                 }
            });
          ...
          <div class="row-fluid">
            <div class="span6 bgcolor">
              <div class="control-group">
                ...
                <div class="controls">
                  <select id="tipo_servico"  name="fl_servico_produto">
                  	<option value="1" <?php if($tes['fl_servico_produto'] == 1) echo 'Selected'; ?>>Servico</option>
                  	<option value="2" <?php if($tes['fl_servico_produto'] == 2) echo 'Selected'; ?>>Produto</option>                  	
                  </select>
                </div>
              </div>             
            </div><!--/span-->
            ...
            <div class="span6 bgcolor">
              <div class="control-group">
                <label class="control-label" for="city">Desc Entrega</label>
                <div class="controls">
                  <textarea id="desc_etapa" name="desc_entrega"><?php echo $tes['desc_entrega'] ?> </textarea> 
                </div>
              </div>
            </div><!--/span-->
          </div><!--row-->
            
            <input type="hidden" name="idEntrega" value="<?php echo $_POST['id']?>">
