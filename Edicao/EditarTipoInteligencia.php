...
<?php
  ...
  //if(isset($_POST['pagina']))
   ...
   $stmt = $con->prepare("SELECT * FROM tipo_inteligencia where id_tipo_inteligencia = :id;");
        ...
        //alert(dados);
            ...
            $.ajax({
                 ...
                 success: function(){
                            ...
                            //alert('ALOHAAAA');
                            $(window.document.location).attr('href','../Cadastro/CadastrarTipoIntelifencia.php');                            
                            });
                 }
            });
          ...
          <div class="row-fluid">
            <div class="span6 bgcolor">
              <div class="control-group">
                <label class="control-label" for="street">Tipo Inteligencia</label>
                <div class="controls">
                  <input type="text" id="desc_tipo_inteligencia" name="desc_tipo_inteligencia" value="<?php echo $tes['desc_tipo_inteligencia']?>">
                </div>
              </div>             
            </div><!--/span-->
            </div><!--row-->
            
            <input type="hidden" name="idTipoInteligencia" value="<?php echo $_POST['id']?>"> 
