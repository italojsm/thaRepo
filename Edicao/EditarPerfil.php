...
<?php
  ...
  //if(isset($_POST['pagina']))
   ...
   $stmt = $con->prepare("SELECT * FROM perfil where id_perfil = :id;");
        ...
        //alert(dados);
            ...
            $.ajax({
                 ...
                 success: function(){
                            ...
                            //alert('ALOHAAAA');
                            $(window.document.location).attr('href','../Cadastro/CadastrarPerfil.php');                            
                            });
                 }
            });
          ...
          <div class="row-fluid">
            <div class="span6 bgcolor">
              <div class="control-group">
                <label class="control-label" for="street">Perfil</label>
                <div class="controls">
                  <input type="text" id="desc_tipo_inteligencia" name="desc_perfil" value="<?php echo $tes['desc_perfil']?>">
                </div>
              </div>             
            </div><!--/span-->
            </div><!--row-->
            
            <input type="hidden" name="idPerfil" value="<?php echo $_POST['id']?>"> 
