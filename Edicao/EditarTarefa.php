...
<?php
 ...
 ini_set("display_errors", 1);
  ...
  //if(isset($_POST['pagina']))
   ...
   $stmt = $con->prepare("SELECT * FROM tarefa where id_tarefa = :id;");
                ...
                <select id="id_atividade" name="id_atividade">
                  <?php
                       ...
                       while($aux = $stmt->fetch(PDO::FETCH_ASSOC)){?>
                  	        <option value="<?php echo $aux['id_atividade']; ?>" <?php if($tes['id_atividade'] == $aux['id_atividade']) echo 'Selected' ?>><?php echo $aux['desc_atividade']; ?></option>
              ...
              <div class="control-group">
                ...
                <select id="id_funcionario" name="id_funcionario">
                  <?php
                       ...
                       $stmt->execute();
                       while($aux = $stmt->fetch(PDO::FETCH_ASSOC)){?>
                  	        <option value="<?php echo $aux['id_funcionario']; ?>" <?php if($tes['id_funcionario'] == $aux['id_funcionario']) echo 'Selected' ?>><?php echo $aux['nome']; ?></option>
          ...
          <div class="row-fluid">
            ...
            <div class="span6 bgcolor">
              <div class="control-group">
                ...
                <div class="controls">
                  <input type="text" id="dt_hr_inicio" name="dt_hr_inicio" class="date" value="<?php echo Date('d-m-Y', strtotime($tes['dt_hr_inicio'])) ?>"> 
                </div>
              </div>
            </div><!--/span-->
                      <div class="span6 bgcolor">
              <div class="control-group">
                ...
                <div class="controls">
                  <input type="text" id="dt_hr_fim" name="dt_hr_fim" class="date" value="<?php echo Date('d-m-Y', strtotime($tes['dt_hr_fim'])) ?>"> 
                </div>
              </div>
            </div><!--/span-->
          </div><!--/row-->           
          <div class="row-fluid">
            ...
            <div class="span6 bgcolor">
              <div class="control-group">
                ...
                <div class="controls">
                  <select id="reponsavel" name="fl_tarefa_bloqueada">
                  	<option value="1" <?php if($tes['fl_tarefa_bloqueada'] == 1) echo 'Selected';?>>Sim</option>
                  	<option value="0" <?php if($tes['fl_tarefa_bloqueada'] == 0) echo 'Selected';?> >Não</option>                  	
                  </select>
                </div>
              </div>         
            </div>  
              ...
              <div class="control-group">
                ...
                <div class="controls">
                  <textarea name="observacao"> <?php echo $tes['observacao']; ?> </textarea>
                </div>
              </div>      
              </div>
