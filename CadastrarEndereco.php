    ...
    $("body").hide().fadeIn('500');
            ...
            $("form").submit(function(){
    		    ...
    		    var dados = $( this ).serialize();
		            ...
		            $.ajax({
		                 url: "controle/InsereEndereco.php",
		                 data: dados, 
		                 type: "POST",
		                 success: function(){
		                            ...
		                            //alert('oopa');
		                            $(window.document.location).attr('href','CadastrarCliente.php');
...
<div class="main">
  <div class="main-inner">
    <div class="container">
      <div class="row">
      	<div class="span12">
        <form class="form-horizontal widget-content"  method="POST" action="controle/InsereEndereco.php">
...
<fieldset>
          <div class="row-fluid">
            <div class="span6 bgcolor">
              <div class="control-group">
                <label class="control-label" for="street">Bairro</label>
                <div class="controls">
                  <input type="text" id="cliente" name="bairro">
                </div>
              </div>             
            </div><!--/span-->
            <div class="span6 bgcolor">
              <div class="control-group">
                <label class="control-label" for="city">Logradouro</label>
                <div class="controls">
                  <input type="text" id="CNPJ" name="logradouro"> 
                </div>
              </div>
            </div><!--/span-->
          </div>
          <div class="row-fluid">
            ...
            <div class="span6 bgcolor">
              <div class="control-group">
                <label class="control-label" for="state">CEP</label>
                <div class="controls">
                  <input type="text" id="razaoSocial" name="cep"> 
                </div>
              </div>
            </div><!--/span-->
                      <div class="span6 bgcolor">
              <div class="control-group">
                <label class="control-label" for="desc_endereco">Descrição endereço</label>
                <div class="controls">
                  <input type="text" id="desc_endereco" name="desc_endereco"> 	
                </div>
              </div>
            </div><!--/span-->
          </div><!--/row-->           
          ...
          <div class="row-fluid">
            <div class="span6 bgcolor">
             ...
             <div class="span6 bgcolor">
              <div class="control-group">
                <label class="control-label" for="reponsavel">UF</label>
                <div class="controls">
                  <select id="id_uf" name="id_uf">
                  <?php
                       $stmt = $con->prepare("SELECT nome_uf, id_uf FROM uf;");
                       $stmt->execute();
                       while($aux = $stmt->fetch(PDO::FETCH_ASSOC)){?>
                  	        <option value="<?php echo $aux['id_uf']; ?>"><?php echo $aux['nome_uf']; ?></option>
