 ...
 $.noConflict();
    ...
    $("#bt").click(function(){
        ...
        $("body").fadeOut(300, function(){
            ...
            $(window.document.location).attr('href','Cadastro/CadastrarEtapa.php');
    ...
    $('a.edit').click(function(){
            ...
            $.ajax({
                 url: "Edicao/EditarTipoInteligencia.php",
                 ...
                 success: function(){
                            ...
                            //alert("alohaaaa");
                              ...
                              $(window).redirect('Edicao/EditarTipoInteligencia.php', { pagina: 'editar', id:txt });
    ...
    $('a.excluir').click(function(){
           ...
           // alert(txt);
            ...
            var r = confirm("Você realmente deseja excluir este tipo de inteligencia?");
            
            if( r == true){  
	            $.ajax({
	                 url: "controle/EditaTipoInteligencia.php",
	                 //data: {pagina: 'editar', id: txt},
	                 data: { pagina: 'editar', id:txt},
	                 //context: document.body,
	                 type: "POST",
	                 success: function(){
	                 		//alert('ALOHAAA');
	                            $("body").fadeOut(500, function(){
	                             ...
	                             $(window.document.location).attr('href','TipoInteligencia.php');
...
<table class="table table-bordered table-striped">
 ...
 <?php while($row = $stmt->fetch(PDO::FETCH_ASSOC)){ if($row['fl_inativo'] != 1){ ?>
  ...
  <tr>
    <td> <?php echo $row['desc_tipo_inteligencia'] ?></td>    
    <td> <a class="edit" onclick="return false"  href="TipoInteligencia.php" rel="<?php echo $row['id_tipo_inteligencia']; ?>">Editar</a> </td>
    <td> <a class="excluir" onclick="return false"  href="TipoInteligencia.php" rel="<?php echo $row['id_tipo_inteligencia']; ?>"> Excluir </a> </td>
  </tr>
